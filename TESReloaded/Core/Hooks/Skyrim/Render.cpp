...
bool (__cdecl* SetupRenderingPass)(UInt32, BSShader*) = (bool (__cdecl*)(UInt32, BSShader*))Hooks::SetupRenderingPass;
...
void (__thiscall* RenderWorldSceneGraph)(Main*, Sun*, UInt8, UInt8) = (void (__thiscall*)(Main*, Sun*, UInt8, UInt8))Hooks::RenderWorldSceneGraph;
...
void (__thiscall* RenderFirstPerson)(Main*, NiDX9Renderer*, NiGeometry*, Sun*, BSRenderedTexture*, UInt8) = (void (__thiscall*)(Main*, NiDX9Renderer*, NiGeometry*, Sun*, BSRenderedTexture*, UInt8))Hooks::RenderFirstPerson;
...
__declspec(naked) void RenderingGeometryHook() {
...
__declspec(naked) void SetShadowDistanceHook() {
...
__declspec(naked) void SetShadowDistanceShaderHook() {
