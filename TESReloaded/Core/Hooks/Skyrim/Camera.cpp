...
int (__thiscall* SetCameraState)(PlayerCamera*, TESCameraState*) = (int (__thiscall*)(PlayerCamera*, TESCameraState*))Hooks::SetCameraState;
...
void (__thiscall* ManageButtonEvent)(PlayerInputHandler*, ButtonEvent*, int) = (void (__thiscall*)(PlayerInputHandler*, ButtonEvent*, int))Hooks::ManageButtonEvent;
...
void (__thiscall* SetCameraPosition)(ThirdPersonState*) = (void (__thiscall*)(ThirdPersonState*))Hooks::SetCameraPosition;
