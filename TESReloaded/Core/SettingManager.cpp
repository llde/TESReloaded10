...
SettingManager::Configuration::SectionPosition SettingManager::Configuration::GoToSection(const char* Section, const char* FromPosition) {
	...
	if (Section) {
		...
		while (Finder != NULL) {
			...
			if (!KeyPositionR) {
				char Error[160];
				sprintf(Error, "CRITICAL ERROR: Cannot find the section %s in the config file.", Section);
				Logger::Log(Error);
...
void SettingManager::Configuration::FillNode(ConfigNode* Node, const char* Section, const char* Key) {
	...
	if (!KeyPosition || KeyPosition > SectionPosition.End) {
		char Error[160];
		sprintf(Error, "CRITICAL ERROR: Cannot find the setting %s in the section %s in the config file.", Key, Section);
		Logger::Log(Error);
		MessageBoxA(NULL, Error, PluginVersion::VersionString, MB_ICONERROR | MB_OK);
		TerminateProcess(GetCurrentProcess(), 0);
	}
...
void SettingManager::Configuration::CreateWeatherSection(const char* WeatherName, TESWeather* Weather) {
	...
	for (UInt32 x = 0; x < TESWeather::kNumColorTypes; x++) {
		...
		sprintf(SectionNode, "<Color%i Value=\"%s\" Type=\"3\" Reboot=\"0\" Versioning=\"11\" Info=\"\" />", x, Value); strcat(Section, SectionNode);
	}
	strcat(Section, "</Colors>");
	strcat(Section, "<HDR>");
	Value[0] = NULL;
...
bool SettingManager::LoadSettings(bool Init) {
	...
	if (Config.Config) {
		...
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapNear].Apparatus = GetSettingI("Shaders.ShadowsExteriors.Near", "Apparatus");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapNear].Books = GetSettingI("Shaders.ShadowsExteriors.Near", "Books");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapNear].Containers = GetSettingI("Shaders.ShadowsExteriors.Near", "Containers");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapNear].Doors = GetSettingI("Shaders.ShadowsExteriors.Near", "Doors");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapNear].Furniture = GetSettingI("Shaders.ShadowsExteriors.Near", "Furniture");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapNear].Misc = GetSettingI("Shaders.ShadowsExteriors.Near", "Misc");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapNear].Statics = GetSettingI("Shaders.ShadowsExteriors.Near", "Statics");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapNear].Terrain = GetSettingI("Shaders.ShadowsExteriors.Near", "Terrain");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapNear].Trees = GetSettingI("Shaders.ShadowsExteriors.Near", "Trees");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapNear].MinRadius = GetSettingF("Shaders.ShadowsExteriors.Near", "MinRadius");
		...
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapFar].Apparatus = GetSettingI("Shaders.ShadowsExteriors.Far", "Apparatus");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapFar].Books = GetSettingI("Shaders.ShadowsExteriors.Far", "Books");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapFar].Containers = GetSettingI("Shaders.ShadowsExteriors.Far", "Containers");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapFar].Doors = GetSettingI("Shaders.ShadowsExteriors.Far", "Doors");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapFar].Furniture = GetSettingI("Shaders.ShadowsExteriors.Far", "Furniture");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapFar].Misc = GetSettingI("Shaders.ShadowsExteriors.Far", "Misc");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapFar].Statics = GetSettingI("Shaders.ShadowsExteriors.Far", "Statics");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapFar].Terrain = GetSettingI("Shaders.ShadowsExteriors.Far", "Terrain");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapFar].Trees = GetSettingI("Shaders.ShadowsExteriors.Far", "Trees");
		...
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapOrtho].Actors = GetSettingI("Shaders.ShadowsExteriors.Ortho", "Actors");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapOrtho].Apparatus = GetSettingI("Shaders.ShadowsExteriors.Ortho", "Apparatus");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapOrtho].Books = GetSettingI("Shaders.ShadowsExteriors.Ortho", "Books");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapOrtho].Containers = GetSettingI("Shaders.ShadowsExteriors.Ortho", "Containers");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapOrtho].Doors = GetSettingI("Shaders.ShadowsExteriors.Ortho", "Doors");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapOrtho].Furniture = GetSettingI("Shaders.ShadowsExteriors.Ortho", "Furniture");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapOrtho].Misc = GetSettingI("Shaders.ShadowsExteriors.Ortho", "Misc");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapOrtho].Statics = GetSettingI("Shaders.ShadowsExteriors.Ortho", "Statics");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapOrtho].Terrain = GetSettingI("Shaders.ShadowsExteriors.Ortho", "Terrain");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapOrtho].Trees = GetSettingI("Shaders.ShadowsExteriors.Ortho", "Trees");
		SettingsShadows.Exteriors.Forms[ShadowManagerBase::ShadowMapTypeEnum::MapOrtho].MinRadius = GetSettingF("Shaders.ShadowsExteriors.Ortho", "MinRadius");
		SettingsShadows.Exteriors.ShadowMapSize[ShadowManagerBase::ShadowMapTypeEnum::MapOrtho] = GetSettingI("Shaders.ShadowsExteriors.Ortho", "ShadowMapSize");
		SettingsShadows.Exteriors.ShadowMapRadius[ShadowManagerBase::ShadowMapTypeEnum::MapOrtho] = GetSettingF("Shaders.ShadowsExteriors.Ortho", "ShadowMapRadius");
...
UInt32 SettingManager::GetSettingI(const char* Section, const char* Key) {
...
void SettingManager::SetSettingWeather(const char* Section, const char* Key, float Value) {
	...
	if (Values[2] == "Main") {
		...
		CreateNodeS(&Node, Section, "HDR", AttributeValue, "100", 0);
	}
	else {
		AttributeValue[0] = NULL;
		for (UInt32 x = 0; x < TESWeather::kNumColorTypes; x++) {
			if (Values[2] == WeatherColorTypes[x]) {
				...
				CreateNodeS(&Node, ColorSection, ColorNode, AttributeValue, "111", 0);
				break;
			}
		}
	}
	...
	if (memcmp(Section, "Weathers", 8)) {
		...
		if (SettingsWeather) {
			if (Values[2] == "Main") {
				...
				for (UInt32 i = 0; i < 14; i++) {
					CreateNodeF(&Node, Section, WeatherHDRTypes[i], SettingsWeather->HDR[i], "100", 0, Configuration::NodeType::Float);
				...
				for (UInt32 i = 0; i < TESWeather::kNumColorTypes; i++) {
					if (Values[2] == WeatherColorTypes[i]) {
						CreateNodeF(&Node, Section, "DayR", SettingsWeather->Colors[i].colors[TESWeather::eTime_Day].r, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "DayG", SettingsWeather->Colors[i].colors[TESWeather::eTime_Day].g, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "DayB", SettingsWeather->Colors[i].colors[TESWeather::eTime_Day].b, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "NightR", SettingsWeather->Colors[i].colors[TESWeather::eTime_Night].r, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "NightG", SettingsWeather->Colors[i].colors[TESWeather::eTime_Night].g, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "NightB", SettingsWeather->Colors[i].colors[TESWeather::eTime_Night].b, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "SunriseR", SettingsWeather->Colors[i].colors[TESWeather::eTime_Sunrise].r, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "SunriseG", SettingsWeather->Colors[i].colors[TESWeather::eTime_Sunrise].g, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "SunriseB", SettingsWeather->Colors[i].colors[TESWeather::eTime_Sunrise].b, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "SunsetR", SettingsWeather->Colors[i].colors[TESWeather::eTime_Sunset].r, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "SunsetG", SettingsWeather->Colors[i].colors[TESWeather::eTime_Sunset].g, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "SunsetB", SettingsWeather->Colors[i].colors[TESWeather::eTime_Sunset].b, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
					}
				}
			}
			...
			if (Values[2] == "Main") {
				...
				for (UInt32 i = 0; i < TESWeather::kNumColorTypes; i++) {
					if (Values[2] == WeatherColorTypes[i]) {
						CreateNodeF(&Node, Section, "DayR", Weather->colors[i].colors[TESWeather::eTime_Day].r, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "DayG", Weather->colors[i].colors[TESWeather::eTime_Day].g, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "DayB", Weather->colors[i].colors[TESWeather::eTime_Day].b, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "NightR", Weather->colors[i].colors[TESWeather::eTime_Night].r, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "NightG", Weather->colors[i].colors[TESWeather::eTime_Night].g, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "NightB", Weather->colors[i].colors[TESWeather::eTime_Night].b, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "SunriseR", Weather->colors[i].colors[TESWeather::eTime_Sunrise].r, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "SunriseG", Weather->colors[i].colors[TESWeather::eTime_Sunrise].g, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "SunriseB", Weather->colors[i].colors[TESWeather::eTime_Sunrise].b, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "SunsetR", Weather->colors[i].colors[TESWeather::eTime_Sunset].r, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "SunsetG", Weather->colors[i].colors[TESWeather::eTime_Sunset].g, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
						CreateNodeF(&Node, Section, "SunsetB", Weather->colors[i].colors[TESWeather::eTime_Sunset].b, "111", 0, Configuration::NodeType::Integer);
						Settings->push_back(Node);
					}
				}
			}
...
void SettingManager::CreateNodeF(Configuration::ConfigNode* Node, const char* Section, const char* Key, float Value, const char* Versioning, bool Reboot, UInt32 Type) {
	...
	strcpy(Node->Versioning, Versioning);
	Node->Reboot = Reboot;
	Node->Type = Type;

}

void SettingManager::CreateNodeS(Configuration::ConfigNode* Node, const char* Section, const char* Key, const char* Value, const char* Versioning, bool Reboot) {
