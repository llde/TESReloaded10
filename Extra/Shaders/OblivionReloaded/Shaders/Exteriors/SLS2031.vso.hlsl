...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    eye2.xyz = normalize(normalize(EyePosition.xyz - IN.LPOSITION.xyz) + LightDirection[0].xyz);
    q4.xyz = mul(float3x3(IN.LTANGENT.xyz, IN.LBINORMAL.xyz, IN.LNORMAL.xyz), LightDirection[0].xyz);
	q5.xyz = mul(float3x3(IN.LTANGENT.xyz, IN.LBINORMAL.xyz, IN.LNORMAL.xyz), eye2.xyz);
    OUT.position.xyzw = r0.xyzw;
    OUT.texcoord_0.xy = IN.LTEXCOORD_0.xy;
    OUT.texcoord_1.xyz = normalize(q4.xyz);
    OUT.texcoord_3.xyz = q5.xyz;
