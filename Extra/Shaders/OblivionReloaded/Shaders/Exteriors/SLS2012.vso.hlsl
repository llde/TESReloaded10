...
#define	sqr(v)			((v) * (v))
    ...
    r3.xyz = (IN.LBLENDWEIGHT.z * r2.xyz) + r3.xyz;
    ...
    r2.xyz = ((1 - weight(IN.LBLENDWEIGHT.xyz)) * r2.xyz) + r3.xyz;
    ...
    q6.xyz = normalize(((1 - weight(IN.LBLENDWEIGHT.xyz)) * r2.xyz) + r3.xyz);
    m38.xyz = mul(float3x3(r1.xyz, r5.xyz, q6.xyz), LightDirection[0].xyz);
    r0.xyz = ((1 - weight(IN.LBLENDWEIGHT.xyz)) * q13.xyz) + q12.xyz;
    eye4.xyz = normalize(normalize(EyePosition.xyz - r0.xyz) + LightDirection[0].xyz);
    mdl15.xyzw = mul(SkinModelViewProj, r0.xyzw);
    m34.xyz = mul(float3x3(r1.xyz, r5.xyz, q6.xyz), eye4.xyz);
    OUT.color_1.rgb = FogColor.rgb;
    OUT.color_1.a = 1 - saturate((FogParam.x - length(mdl15.xyz)) / FogParam.y);
    OUT.position.xyzw = mdl15.xyzw;
    OUT.texcoord_0.xy = IN.LTEXCOORD_0.xy;
    OUT.texcoord_1.xyz = normalize(m38.xyz);
    OUT.texcoord_3.xyz = m34.xyz;
    OUT.texcoord_6.xyzw = mul(mdl15.xyzw, TESR_ShadowCameraToLightTransform[0]);
	OUT.texcoord_7.xyzw = mul(mdl15.xyzw, TESR_ShadowCameraToLightTransform[1]);
    return OUT;
