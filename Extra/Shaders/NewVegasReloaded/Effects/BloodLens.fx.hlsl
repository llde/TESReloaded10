...
sampler2D TESR_BloodLensSampler : register(s1); // samplerState1 { TEXTURE = Effects\bloodlens.dds; ADDRESSU = WRAP; ADDRESSV = WRAP; MAGFILTER = LINEAR; MINFILTER = LINEAR; MIPFILTER = LINEAR; }
